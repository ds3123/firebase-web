"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[4358],{9978:function(e,t,n){n.d(t,{Bt:function(){return sc},ET:function(){return so},IO:function(){return i0},JU:function(){return i_},QT:function(){return sr},Xo:function(){return i3},ad:function(){return iC},cf:function(){return sl},hJ:function(){return iv},oe:function(){return sa},r7:function(){return ss}});var r,i,s=n(3991),a=n(5538),o=n(6914),l=n(8745),u=n(613);n(2601);let h="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sr(e){e=id(e,iy);let t=id(e.firestore,iI);return(function(e,t,n={}){let r=new T;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new r6({next:s=>{t.enqueueAndForget(()=>rR(e,a));let o=s.docs.has(n);!o&&s.fromCache?i.reject(new E(_.UNAVAILABLE,"Failed to get document because the client is offline.")):o&&s.fromCache&&r&&"server"===r.source?i.reject(new E(_.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(s)},error:e=>i.reject(e)}),a=new rV(e1(n.path),s,{includeMetadataChanges:!0,J_:!0});return rD(e,a)})(await is(e),e.asyncQueue,t,n,r)),r.promise})(iS(t),e._key).then(n=>sh(t,e,n))}class si extends i6{constructor(e){super(),this.firestore=e}convertBytes(e){return new iN(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new iy(this.firestore,null,t)}}function ss(e,t,n,...r){e=id(e,iy);let i=id(e.firestore,iI),s=iF(i);return su(i,[("string"==typeof(t=(0,l.m9)(t))||t instanceof ib?function(e,t,n,r,i,s){let a=e.pu(1,t,n),o=[iK(t,r,n)],u=[i];if(s.length%2!=0)throw new E(_.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let e=0;e<s.length;e+=2)o.push(iK(t,s[e])),u.push(s[e+1]);let h=[],c=eD.empty();for(let e=o.length-1;e>=0;--e)if(!iW(h,o[e])){let t=o[e],n=u[e];n=(0,l.m9)(n);let r=a.Ru(t);if(n instanceof iP)h.push(t);else{let e=iq(n,r);null!=e&&(h.push(t),c.set(t,e))}}return new iL(c,new er(h),a.fieldTransforms)}(s,"updateDoc",e._key,t,n,r):function(e,t,n,r){let i=e.pu(1,t,n);i$("Data must be an object, but it was:",i,r);let s=[],a=eD.empty();return Y(r,(e,r)=>{let o=iQ(t,e,n);r=(0,l.m9)(r);let u=i.Ru(o);if(r instanceof iP)s.push(o);else{let e=iq(r,u);null!=e&&(s.push(o),a.set(o,e))}}),new iL(a,new er(s),i.fieldTransforms)}(s,"updateDoc",e._key,t)).toMutation(e._key,tN.exists(!0))])}function sa(e){return su(id(e.firestore,iI),[new tP(e._key,tN.none())])}function so(e,t){var n,r;let i=id(e.firestore,iI),s=i_(e),a=(n=e.converter)?r&&(r.merge||r.mergeFields)?n.toFirestore(t,r):n.toFirestore(t):t;return su(i,[(function(e,t,n,r,i,s={}){let a,o;let l=e.pu(s.merge||s.mergeFields?2:0,t,n,i);i$("Data must be an object, but it was:",l,r);let u=iB(r,l);if(s.merge)a=new er(l.fieldMask),o=l.fieldTransforms;else if(s.mergeFields){let e=[];for(let r of s.mergeFields){let i=iK(t,r,n);if(!l.contains(i))throw new E(_.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);iW(e,i)||e.push(i)}a=new er(e),o=l.fieldTransforms.filter(e=>a.covers(e.field))}else a=null,o=l.fieldTransforms;return new ix(new eD(u),a,o)})(iF(e.firestore),"addDoc",s._key,a,null!==e.converter,{}).toMutation(s._key,tN.exists(!1))]).then(()=>s)}function sl(e,...t){var n,r,i;let s,a,o;e=(0,l.m9)(e);let u={includeMetadataChanges:!1},h=0;"object"!=typeof t[0]||iT(t[h])||(u=t[h],h++);let c={includeMetadataChanges:u.includeMetadataChanges};if(iT(t[h])){let e=t[h];t[h]=null===(n=e.next)||void 0===n?void 0:n.bind(e),t[h+1]=null===(r=e.error)||void 0===r?void 0:r.bind(e),t[h+2]=null===(i=e.complete)||void 0===i?void 0:i.bind(e)}if(e instanceof iy)a=id(e.firestore,iI),o=e1(e._key.path),s={next:n=>{t[h]&&t[h](sh(a,e,n))},error:t[h+1],complete:t[h+2]};else{let n=id(e,ig);a=id(n.firestore,iI),o=n._query;let r=new si(a);s={next:e=>{t[h]&&t[h](new sn(a,r,n,e))},error:t[h+1],complete:t[h+2]},/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e){if("L"===e.limitType&&0===e.explicitOrderBy.length)throw new E(_.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}(e._query)}return function(e,t,n,r){let i=new r6(r),s=new rV(t,i,n);return e.asyncQueue.enqueueAndForget(async()=>rD(await is(e),s)),()=>{i.Na(),e.asyncQueue.enqueueAndForget(async()=>rR(await is(e),s))}}(iS(a),o,c,s)}function su(e,t){return function(e,t){let n=new T;return e.asyncQueue.enqueueAndForget(async()=>rG(await ii(e).then(e=>e.syncEngine),t,n)),n.promise}(iS(e),t)}function sh(e,t,n){let r=n.docs.get(t._key),i=new si(e);return new se(e,i,t._key,r,new i7(n.hasPendingWrites,n.fromCache),t.converter)}function sc(){return new iU("serverTimestamp")}new WeakMap,function(e=!0){d=s.Jn,(0,s.Xd)(new a.wA("firestore",(t,{instanceIdentifier:n,options:r})=>{let i=t.getProvider("app").getImmediate(),s=new iI(new A(t.getProvider("auth-internal")),new D(t.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new E(_.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new em(e.options.projectId,t)}(i,n),i);return r=Object.assign({useFetchStreams:e},r),s._setSettings(r),s},"PUBLIC").setMultipleInstances(!0)),(0,s.KN)(h,"4.4.0",void 0),(0,s.KN)(h,"4.4.0","esm2017")}()}}]);